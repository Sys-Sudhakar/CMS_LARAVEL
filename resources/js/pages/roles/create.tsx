            ...
            <div className="max-w-5xl space-y-6">
                ...
                <div>
                    ...
                    <p className="mt-1 text-sm text-gray-600">
                        Create a CMS role and define exactly what users assigned to it can access.
                    </p>
                    ...
                    <div className="rounded-xl border border-gray-200 bg-white p-6">
                        ...
                        <div className="mb-5">
                            ...
                            <p className="mt-1 text-sm text-gray-500">
                                Provide a clear role name and description.
                            </p>
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className="
                                        ...
                                        focus:ring-blue-100
                                    "
                                    placeholder="Example: Content Editor"
                                />
                        ...
                        <div className="border-b border-gray-200 p-6">
                            ...
                            <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                                ...
                                <div>
                                    ...
                                    <p className="mt-1 text-sm text-gray-500">
                                        Search and select the permissions this role should receive.
                                    </p>
                            ...
                            <div className="flex flex-col gap-3 xl:flex-row xl:items-center xl:justify-between">
                                ...
                                <div className="relative w-full xl:max-w-xl">
                                    ...
                                    <input
                                        ...
                                        placeholder="Search permissions, e.g. media, users, edit..."
                                        className="
                                            w-full
                                            rounded-lg
                                            border
                            ...
                            0 ? (
                                ...
                                <div className="py-12 text-center">
                                    ...
                                    <p className="mt-1 text-xs text-gray-500">
                                        Try changing the search or selected-only filter.
                                    </p>

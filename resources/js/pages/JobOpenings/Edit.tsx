...
export default function Edit({ job, websites }: EditJobOpeningProps) {
    /**
     * Laravel may return a date as:
    ...
    const {
        ...
        website_ids: job.website_id ? [String(job.website_id)] : [],
        title: job.title ?? '',
                ...
                <div className="mb-6 flex items-center justify-between">
                    <div>
                        ...
                        <p className="mt-1 text-sm text-gray-500">
                            Update the job opening and choose the websites where it should be published.
                        </p>
                    </div>
                            ...
                            <div className="mb-3 flex flex-wrap items-center justify-between gap-3">
                                <div>
                                    ...
                                    <p className="mt-1 text-xs text-gray-500">
                                        Select one or more websites where this job opening should be available.
                                    </p>
                                </div>
